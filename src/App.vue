    ...
    <div className="max-w-6xl mx-auto">
      <div className="relative">
        <div className="absolute inset-0 flex items-center justify-center opacity-5">
          <div className="text-[20rem] font-black text-gray-800">
            LOGO
          </div>
        </div>

        <div className="relative z-10 text-center py-20">
          <h1 className="text-6xl md:text-8xl font-black mb-6 bg-gradient-to-r from-200 via-teal-600 to-indigo-600 bg-clip-text text-transparent animate-in fade-in slide-in-from-bottom-8 duration-1000">
            Hello, I'm Aldwin Rich
          </h1>
          <p className="text-2xl md:text-3xl text-gray-700 mb-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
